...
func Test_stringSubset(t *testing.T) {
	...
	t.Run("single color/esc seq", func(t *testing.T) {
		...
		assert.Equal(t, "\x1b[38;5;0;48;5;12mG\x1b[0m", stringSubset(input, 0, 0))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGh\x1b[0m", stringSubset(input, 0, 1))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGho\x1b[0m", stringSubset(input, 0, 2))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGhos\x1b[0m", stringSubset(input, 0, 3))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGhost\x1b[0m", stringSubset(input, 0, 4))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGhost\x1b[0m", stringSubset(input, 0, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mhost\x1b[0m", stringSubset(input, 1, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12most\x1b[0m", stringSubset(input, 2, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mst\x1b[0m", stringSubset(input, 3, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mt\x1b[0m", stringSubset(input, 4, 5))
	...
	t.Run("dual color/esc seq", func(t *testing.T) {
		...
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGh\x1b[0m", stringSubset(input, 0, 1))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGho\x1b[0m", stringSubset(input, 0, 2))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGho\x1b[0m\x1b[38;5;0;48;5;22ms\x1b[0m", stringSubset(input, 0, 3))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGho\x1B[0m\x1B[38;5;0;48;5;22mst\x1b[0m", stringSubset(input, 0, 4))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mGho\x1B[0m\x1B[38;5;0;48;5;22mst\x1b[0m", stringSubset(input, 0, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mho\x1B[0m\x1B[38;5;0;48;5;22mst\x1b[0m", stringSubset(input, 1, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;12mo\x1B[0m\x1B[38;5;0;48;5;22mst\x1b[0m", stringSubset(input, 2, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;22mst\x1b[0m", stringSubset(input, 3, 5))
		assert.Equal(t, "\x1b[38;5;0;48;5;22mt\x1b[0m", stringSubset(input, 4, 5))
		assert.Equal(t, "", stringSubset(input, 5, 4))
	})
}
